...
$query	=	"select * from bartanitemlist  ";
		...
		while($row		=	mysqli_fetch_array($rs))
		{
                    ...
                    <td >'.$row['id'].'</td>
								...
								<td> <a  href="functions.php?BartanItemDel='.$row['id'].'"><i class="fa fa-minus-square icon-white"></i></a> &nbsp  <a  href="BartanItemListUpdate.php?id='.$row['id'].'"><i class="fa fa-edit icon-white"></i></a></td>
								</tr>  ';
		}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   echo $query = "INSERT INTO bartanitemlist (item,gujrati)  values ('$item','$gujrati')";
    $rs1=	mysqli_query($conn,$query) or die(mysqli_error());
    header("location:functions.php?bartanAddItem=1"); 
