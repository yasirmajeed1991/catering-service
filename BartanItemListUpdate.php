...
$id = $_GET['id'];
						...
						$query			=	"select * from bartanitemlist where id = $id  ";
						...
						if($_SERVER["REQUEST_METHOD"] == "POST"){
						 ...
						 $query = "Update bartanitemlist SET item='$item', gujrati='$gujrati'  where id=$id";
						$rs	   =  mysqli_query($conn,$query) or die(mysqli_error());
						header("location:functions.php?BartanItemUpdate=1"); 
